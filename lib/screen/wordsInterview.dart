...
class WordsJopInterview extends StatelessWidget {
  WordsJopInterview({super.key});
            ...
            child: Padding(
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  return TextTranse(
                    textAribiec:
                        UserTextTranse().wordsJopInterviewArabick[index],
                    vsText: "=",
                    textEnglish:
                        UserTextTranse().wordsJopInterviewEnglish[index],
                  );
                },
              ),
            ),
